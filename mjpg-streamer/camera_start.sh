...
./mjpg_streamer -o "output_http.so -w /home/pi/oven_cam/mjpg-streamer/www -p 8081 -c etxea:etxean3sb" -i "input_raspicam.so -rot 270 -fps 25 -q 50 -x 320 -y 240 ex night"
